...
package org.zeron.sophon.authn.support.rememberme;
...
public class JdbcRemeberMeManager extends AbstractRemeberMeManager {
    ...
    private static final String DEFAULT_DEFAULT_INSERT_STATEMENT = 
            "insert into  ze_remember_me(id, userid,username,lastlogintime,expirationtime)values( ? , ? , ? , ? , ?)";

    private static final String DEFAULT_DEFAULT_SELECT_STATEMENT = 
            "select id, userid,username,lastlogintime,expirationtime  from ze_remember_me " 
                    + " where id = ?  and username = ?";

    private static final String DEFAULT_DEFAULT_DELETE_STATEMENT = 
            "delete from  ze_remember_me where  username = ?";

    private static final String DEFAULT_DEFAULT_UPDATE_STATEMENT = 
            "update ze_remember_me  set  lastlogintime = ? , expirationtime = ?  where id = ?";
