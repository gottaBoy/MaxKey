...
package org.zeron.sophon.authn.session.impl;
...
public class SessionManagerImpl implements SessionManager{
    ...
    private static final String DEFAULT_DEFAULT_SELECT_STATEMENT = 
            "select id,sessionid,userId,username,displayname,logintime from ze_history_login where sessionstatus = 1";
    
    private static final String LOGOUT_USERINFO_UPDATE_STATEMENT = 
            "update ze_userinfo set lastlogofftime = ? , online = " + UserInfo.ONLINE.OFFLINE + "  where id = ?";
    
    private static final String HISTORY_LOGOUT_UPDATE_STATEMENT = 
            "update ze_history_login set logouttime = ? ,sessionstatus = 7 where  sessionid = ?";
    
    private static final String NO_SESSION_UPDATE_STATEMENT = 
            "update ze_history_login set sessionstatus = 7 where sessionstatus = 1 and (sessionid is null or sessionid = '')";
