...
package org.zeron.sophon.provision.thread;
...
import org.zeron.sophon.entity.Connectors;
import org.zeron.sophon.entity.Message;
import org.zeron.sophon.entity.idm.Organizations;
...
import org.zeron.sophon.provision.ProvisionAct;
import org.zeron.sophon.provision.ProvisionMessage;
import org.zeron.sophon.provision.ProvisionTopic;
...
public class ProvisioningRunner {
    ...
    static final String PROVISION_SELECT_STATEMENT = "select * from ze_history_provisions where connected = 0 order by sendtime asc limit 500";
    
    static final String PROVISION_UPDATE_STATEMENT = "update ze_history_provisions set connected = connected + 1  where  id = ?";
    
    static final String PROVISION_LOG_INSERT_STATEMENT = "insert into ze_history_connector(id,conname,topic,actiontype,sourceid,sourcename,synctime,result,instid) values (? , ? , ? , ? , ? , ?  , ?  , ?  , ? )";
