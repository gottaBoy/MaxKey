...
package org.zeron.sophon.authz.saml20.metadata;
...
public  void samlmtest(){
        try {
            ...
            descriptor.getSingleSignOnServices().add(getSingleSignOnService("http://sso.Sophon.org/sso",null));
            
            descriptor.getSingleSignOnServices().add(getSingleSignOnService("http://sso.Sophon.org/sso",SAMLConstants.SAML2_POST_SIMPLE_SIGN_BINDING_URI));
            
            descriptor.getSingleLogoutServices().add(getSingleLogoutService("http://sso.Sophon.org/slo",null));
            ...
            descriptor.getContactPersons().add(getContactPerson("Sophon","shi","ming","shimingxy@163.com","18724229876",null));
             
            descriptor.setOrganization(getOrganization("Sophon","Sophon","http://sso.Sophon.org"));
