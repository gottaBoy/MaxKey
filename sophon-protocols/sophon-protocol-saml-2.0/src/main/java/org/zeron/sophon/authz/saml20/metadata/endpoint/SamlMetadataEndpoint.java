...
package org.zeron.sophon.authz.saml20.metadata.endpoint;


import org.apache.commons.lang.Validate;
import org.zeron.sophon.authz.saml.common.TrustResolver;
import org.zeron.sophon.authz.saml20.metadata.MetadataGenerator;
...
public class SamlMetadataEndpoint {
    ...
    @Operation(summary = "SAML 2.0 元数据接口", description = "参数ze_metadata_APPID",method="GET")
    @RequestMapping(value = "/" + WebConstants.ZE_METADATA_PREFIX + "{appid}.xml",produces = "application/xml", method={RequestMethod.POST, RequestMethod.GET})
    @ResponseBody
    public String  metadata(HttpServletRequest request,
        ...
        try{
            ...
            descriptor.getManageNameIDServices().add(
                    metadataGenerator.getManageNameIDService(WebContext.getContextPath(true) + "/metadata/saml20/" + WebConstants.ZE_METADATA_PREFIX + appId + ".xml"));
