 ...
 * 
 */
package org.zeron.sophon.authz.token.endpoint;
...
import org.zeron.sophon.authz.jwt.endpoint.adapter.JwtAdapter;
...
import org.zeron.sophon.persistence.service.AppsJwtDetailsService;
...
public class JwtAuthorizeEndpoint extends AuthorizeBaseEndpoint{
    ...
    @Operation(summary = "JWT JWK元数据接口", description = "参数ze_metadata_APPID")
    @GetMapping(value = "/metadata/jwt/" + WebConstants.ZE_METADATA_PREFIX + "{appid}.{mediaType}")
    @ResponseBody
