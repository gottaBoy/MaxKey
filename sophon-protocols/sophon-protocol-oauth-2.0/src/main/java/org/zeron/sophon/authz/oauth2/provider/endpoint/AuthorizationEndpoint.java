...
package org.zeron.sophon.authz.oauth2.provider.endpoint;
...
import org.zeron.sophon.authz.oauth2.common.OAuth2AccessToken;
import org.zeron.sophon.authz.oauth2.common.OAuth2Constants;
import org.zeron.sophon.authz.oauth2.common.exceptions.InvalidClientException;
import org.zeron.sophon.authz.oauth2.common.exceptions.InvalidRequestException;
import org.zeron.sophon.authz.oauth2.common.exceptions.OAuth2Exception;
import org.zeron.sophon.authz.oauth2.common.exceptions.RedirectMismatchException;
import org.zeron.sophon.authz.oauth2.common.exceptions.UnapprovedClientAuthenticationException;
import org.zeron.sophon.authz.oauth2.common.exceptions.UnsupportedResponseTypeException;
import org.zeron.sophon.authz.oauth2.common.exceptions.UserDeniedAuthorizationException;
import org.zeron.sophon.authz.oauth2.common.util.OAuth2Utils;
import org.zeron.sophon.authz.oauth2.provider.AuthorizationRequest;
import org.zeron.sophon.authz.oauth2.provider.OAuth2Authentication;
import org.zeron.sophon.authz.oauth2.provider.OAuth2Request;
import org.zeron.sophon.authz.oauth2.provider.OAuth2RequestValidator;
import org.zeron.sophon.authz.oauth2.provider.TokenRequest;
import org.zeron.sophon.authz.oauth2.provider.approval.DefaultUserApprovalHandler;
import org.zeron.sophon.authz.oauth2.provider.approval.UserApprovalHandler;
import org.zeron.sophon.authz.oauth2.provider.code.AuthorizationCodeServices;
import org.zeron.sophon.authz.oauth2.provider.implicit.ImplicitTokenRequest;
import org.zeron.sophon.authz.oauth2.provider.request.DefaultOAuth2RequestValidator;
import org.zeron.sophon.entity.Message;
import org.zeron.sophon.entity.apps.Apps;
import org.zeron.sophon.entity.apps.oauth2.provider.ClientDetails;
...
public class AuthorizationEndpoint extends AbstractEndpoint {
    ...
    @Operation(summary = "OAuth 2.0 认证接口", description = "传递参数应用ID，自动完成跳转认证拼接")
    ...
    @Operation(summary = "OAuth 2.0 认证接口", description = "传递参数client_id,response_type,redirect_uri等")
    @GetMapping(value = {
