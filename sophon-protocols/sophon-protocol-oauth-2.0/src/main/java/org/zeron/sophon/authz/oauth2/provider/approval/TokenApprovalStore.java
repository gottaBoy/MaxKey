...
package org.zeron.sophon.authz.oauth2.provider.approval;
...
import org.zeron.sophon.authz.oauth2.provider.approval.Approval.ApprovalStatus;
...
public class TokenApprovalStore implements ApprovalStore {
     ...
     * 
     * @see org.zeron.sophon.authz.oauth2.provider.approval.ApprovalStore#addApprovals(java.util.Collection)
     */
    @Override
     ...
     * 
     * @see org.zeron.sophon.authz.oauth2.provider.approval.ApprovalStore#revokeApprovals(java.util.Collection)
     */
    @Override
     ...
     * 
     * @see org.zeron.sophon.authz.oauth2.provider.approval.ApprovalStore#getApprovals(java.lang.String,
     * java.lang.String)
     */
    @Override
