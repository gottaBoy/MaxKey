...
import org.zeron.sophon.authz.oauth2.provider.CompositeTokenGranter;
import org.zeron.sophon.authz.oauth2.provider.OAuth2RequestFactory;
import org.zeron.sophon.authz.oauth2.provider.TokenGranter;
import org.zeron.sophon.authz.oauth2.provider.client.ClientCredentialsTokenGranter;
import org.zeron.sophon.authz.oauth2.provider.code.AuthorizationCodeServices;
import org.zeron.sophon.authz.oauth2.provider.code.AuthorizationCodeTokenGranter;
import org.zeron.sophon.authz.oauth2.provider.code.InMemoryAuthorizationCodeServices;
import org.zeron.sophon.authz.oauth2.provider.implicit.ImplicitTokenGranter;
import org.zeron.sophon.authz.oauth2.provider.password.ResourceOwnerPasswordTokenGranter;
import org.zeron.sophon.authz.oauth2.provider.refresh.RefreshTokenGranter;
import org.zeron.sophon.authz.oauth2.provider.request.DefaultOAuth2RequestFactory;
import org.zeron.sophon.authz.oauth2.provider.token.AuthorizationServerTokenServices;
