...
package org.zeron.sophon.authz.oauth2.provider.wellknown.endpoint;

import com.alibaba.cloud.commons.lang.StringUtils;
import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import org.zeron.sophon.authz.oauth2.common.OAuth2Constants;
import org.zeron.sophon.authz.oauth2.provider.endpoint.AbstractEndpoint;
import org.zeron.sophon.authz.oauth2.provider.wellknown.OpenidConfiguration;
...
public class OpenidConfigurationEndpoint extends AbstractEndpoint {
    ...
    @Operation(summary = "OpenID Connect metadata 元数据接口", description = "参数inst_id,client_id")
    ...
    @Operation(summary = "OpenID Connect metadata 元数据接口", description = "参数Path")
    ...
    public OpenidConfiguration  configurationMetadata(String instId,String clientId,String param) {
        ...
        if(clientDetails != null) {
            ...
            openidConfig.setIssuer(baseUrl + "/Sophon");
