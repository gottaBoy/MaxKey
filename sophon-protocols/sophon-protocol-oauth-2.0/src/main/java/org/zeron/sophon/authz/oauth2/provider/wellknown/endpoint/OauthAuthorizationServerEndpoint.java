...
import org.zeron.sophon.authz.oauth2.provider.wellknown.OauthServerConfiguration;
...
public class OauthAuthorizationServerEndpoint extends AbstractEndpoint {
    ...
    @Operation(summary = "OAuth v2 metadata 元数据接口", description = "参数client_id")
    ...
    @Operation(summary = "OAuth v2 metadata 元数据接口", description = "参数instId,client_id")
    ...
    public OauthServerConfiguration  configurationMetadata(String instId,String clientId,String param) {
        ...
        if(clientDetails != null) {
            ...
            oauthConfig.setIssuer(baseUrl + "/Sophon");
