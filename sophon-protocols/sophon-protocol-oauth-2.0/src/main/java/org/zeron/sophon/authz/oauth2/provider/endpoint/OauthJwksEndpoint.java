...
public class OauthJwksEndpoint extends AbstractEndpoint {
    ...
    @Operation(summary = "OAuth JWk 元数据接口", description = "参数ze_metadata_clientId",method="GET")
    @RequestMapping(
            value = "/metadata/oauth/v20/" + WebConstants.ZE_METADATA_PREFIX + "{clientId}.{mediaType}",
            method={RequestMethod.POST, RequestMethod.GET})
    @ResponseBody
