...
package org.zeron.sophon.authz.exapi.endpoint.adapter;
...
/**
 * 
 * http://target.Sophon.org/demo/login?code=Sophon&time=timestamp&token=token
 * login url http://target.Sophon.org/demo/login?code=%s&timestamp=%s&token=%s
 * 
 * $code          = 'Sophon';
