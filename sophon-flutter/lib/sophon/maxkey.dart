...
import 'package:sophon_flutter/maxkey/services/authn.service.dart';
import 'package:sophon_flutter/maxkey/services/image_captcha.service.dart';
import 'package:sophon_flutter/maxkey/services/time_based.service.dart';
...
class MaxKey with ChangeNotifier {
  final _dio = Dio(BaseOptions(
    baseUrl: SophonPersistent.instance.baseUrl,
            ...
            SnackBar(
              ...
              action: SnackBarAction(
                ...
                onPressed: () async {
                  ...
                  await SophonPersistent.instance.clearToken();
  ...
  void updateBaseUrl() {
    ...
    _dio.options.baseUrl = SophonPersistent.instance.baseUrl;
  ...
  Future<bool> maxKeyNetworkTest({String? host}) async {
    try {
      ...
      LOGGER.i(
        "[MaxKeyNetworkTest] GET: ${host == null ? SophonPersistent.instance.baseUrl : "http://$host/sign"}",
      );

      await _dio
          .get(host == null
              ? SophonPersistent.instance.baseUrl
              : "http://$host/sign")
