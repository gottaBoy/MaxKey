...
import 'package:sophon_flutter/app_color_scheme.dart';
import 'package:sophon_flutter/maxkey/maxkey.dart';
import 'package:sophon_flutter/maxkey/services/users.service.dart';
import 'package:sophon_flutter/pages/home_page/page.dart';
import 'package:sophon_flutter/pages/login_page/page.dart';
import 'package:sophon_flutter/pages/scan_page.dart';
import 'package:sophon_flutter/pages/settings_page/page.dart';
import 'package:sophon_flutter/pages/user_page/page.dart';
...
class AppEntry extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        valueListenable: SophonPersistent.instance.themeModeListenable,
