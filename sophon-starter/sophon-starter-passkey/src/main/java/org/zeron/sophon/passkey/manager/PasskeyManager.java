...
package org.zeron.sophon.passkey.manager;
...
public class PasskeyManager {
    ...
    public Map<String, Object> beginRegistration(String userId, String username, String displayName) {
        ...
        try {
            ...
            if (existingPasskeys.size() >= 5) { // 限制每个用户最??个Passkey
            ...
            throw new RuntimeException("开始注册失?? " + e.getMessage(), e);
        }
    }
    ...
    public Map<String, Object> beginAuthentication(String userId) {
        ...
        try {
            ...
            throw new RuntimeException("开始认证失?? " + e.getMessage(), e);
        }
    }
