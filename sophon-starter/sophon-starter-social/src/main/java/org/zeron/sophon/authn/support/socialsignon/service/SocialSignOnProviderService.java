...
public class SocialSignOnProviderService{
    ...
    private static final String DEFAULT_SELECT_STATEMENT = "select * from ze_socials_provider where instid = ? and status = 1  order by sortindex";
    ...
    public AuthRequest  getAuthRequest(String instId,String provider,String baseUri)  throws Exception {
        ...
        }else if(provider.equalsIgnoreCase("Sophon")) {
            authRequest = new AuthSophonRequest(authConfig);
        }
