 ...
 * 
 */
package org.zeron.sophon.authn.support.socialsignon;

import me.zhyd.oauth.request.AuthSophonRequest;
...
import org.zeron.sophon.uuid.UUID;
...
public class SocialSignOnEndpoint  extends AbstractSocialSignOnEndpoint{
    ...
    public Message<SocialsProvider> scanQRCode(HttpServletRequest request,@PathVariable("provider") String provider) {
        ...
        if(authRequest != null ) {
            ...
            if (provider.equalsIgnoreCase(AuthSophonRequest.KEY)) {
