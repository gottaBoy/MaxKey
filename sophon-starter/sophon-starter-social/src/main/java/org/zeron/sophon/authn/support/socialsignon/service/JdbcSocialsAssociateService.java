...
package org.zeron.sophon.authn.support.socialsignon.service;
...
import org.zeron.sophon.constants.ConstsDatabase;
import org.zeron.sophon.entity.SocialsAssociate;
...
public class JdbcSocialsAssociateService   implements SocialsAssociateService{
    ...
    private static final String DEFAULT_DEFAULT_INSERT_STATEMENT = "insert into  ze_socials_associate(id, userid , username , provider , socialuserid , accesstoken , socialuserinfo , exattribute , instid)values( ? , ? , ? , ? , ?, ? , ? , ?, ?)";
    
    private static final String DEFAULT_DEFAULT_INSERT_STATEMENT_ORACLE = "insert into  ze_socials_associate(id, userid , username , provider , socialuserid , accesstoken , socialuserinfo , exattribute , instid)values( ? , ? , ? , ? , ?, ? , ? , ?, ?)";

    private static final String DEFAULT_DEFAULT_SIGNON_SELECT_STATEMENT = "select id, userid , username , provider , socialuserid , accesstoken , socialuserinfo , exattribute , createddate , updateddate , instid from ze_socials_associate where provider = ?  and socialuserid = ? and instId = ?";

    private static final String DEFAULT_DEFAULT_BIND_SELECT_STATEMENT = "select id, userid , username , provider , socialuserid , accesstoken , socialuserinfo , exattribute , createddate , updateddate , instid from ze_socials_associate where userid = ?" ;
    
    private static final String DEFAULT_DEFAULT_DELETE_STATEMENT = "delete from  ze_socials_associate where  userid = ? and provider = ?";
    
    private static final String DEFAULT_DEFAULT_UPDATE_STATEMENT= "update ze_socials_associate  set accesstoken  = ? , socialuserinfo = ? , exattribute = ? ,updateddate = ?  where id = ?";
