...
public class SwaggerAutoConfiguration {
    ...
    @Value("${sophon.swagger.title}")
    String title;
    
    @Value("${sophon.swagger.description}")
    String description;
    
    @Value("${sophon.swagger.version}")
    String version;
    
    @Value("${sophon.swagger.enable}")
    boolean enable;
    ...
    GroupedOpenApi userApi(){
        ...
        String[] packagedToMatch = { "org.zeron.sophon.authz" };
        ...
        return new OpenAPI()
                .info(
                    new Info()
                        ...
                        .version(version)
                        .termsOfService("https://www.sophon.console/")
                        .license(
                            new License()
                ...
                externalDocs(
                        ...
                        .description("Sophon.top contact support@maxsso.net")
                        .url("https://www.sophon.console/")
                );
    }
}
