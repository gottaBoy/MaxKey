...
public class WebConstants {
    ...
    public static final   String INST_COOKIE_NAME     = "ze_inst";
    ...
    public static final  String THEME_COOKIE_NAME = "ze_theme_value";
    ...
    public static final  String ZE_METADATA_PREFIX = "ze_metadata_";
