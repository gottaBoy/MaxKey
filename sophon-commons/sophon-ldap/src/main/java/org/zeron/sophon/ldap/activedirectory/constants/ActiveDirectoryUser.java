...
package org.zeron.sophon.ldap.activedirectory.constants;
...
public class ActiveDirectoryUser {
     ...
     *    办公??              Office                physicalDeliveryOfficeName
     ...
     *    注释                Notes                info
     *帐号
     *    用户登录??         UserLogon Name        userPrincipalName
     *    用户登录名（以前版本）User logon name (pre-Windows 2000)    sAMAccountname
     *    登录时间            Logon Hours            logonHours
     *    登录??              Log On To            logonWorkstation
     *    用户帐户控制     Account is locked out    userAccountControl   (启用??12，禁用：514，密码永不过期：66048)  
     ...
     *    直接汇报??          Direct Reports        directReports
     *
     *成员
     *    成员属于            Member of            memberOf
     *    主要??             Set Primary Group     primaryGroupID
     */
