...
public class DateUtils {
    ...
    /**
     * Determine if value date is before date
     * @param value
     * @param date
     * @param datePattern
     * @return
