...
/**
 * 描述: Twitter的分布式自增ID雪花算法snowflake (Java??
 *
 * @author yi.min
 * @create 2021-04-17
 **/
public class SnowFlakeId {
    ...
    private static final  long MACHINE_BIT = 5;   //机器标识占用的位??
    private static final  long DATACENTER_BIT = 5;//数据中心占用的位??
    ...
    public synchronized long nextId() {
        ...
        return (currStmp - START_STMP) << TIMESTMP_LEFT //时间戳部??
