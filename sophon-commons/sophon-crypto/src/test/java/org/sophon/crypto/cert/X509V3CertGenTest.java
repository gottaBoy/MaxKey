...
package org.Sophon.crypto.cert;
...
import org.zeron.sophon.crypto.cert.X509V3CertGen;
...
public class X509V3CertGenTest {
    ...
    public void generateV3() throws Exception {
        ...
        String issuer="CN=Sophon.top,O=Sophon,L=SH,ST=SH,C=CN";
        ...
        String certFileString = "D:\\Sophon\\Workspaces\\Sophon\\Cert345.cer";
