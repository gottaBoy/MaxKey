...
import org.zeron.sophon.web.interceptor.RestApiPermissionAdapter;
...
@EnableWebMvc
@AutoConfiguration
public class SophonOpenApiMvcConfig implements WebMvcConfigurer {
    private static final  Logger logger = LoggerFactory.getLogger(SophonOpenApiMvcConfig.class);
