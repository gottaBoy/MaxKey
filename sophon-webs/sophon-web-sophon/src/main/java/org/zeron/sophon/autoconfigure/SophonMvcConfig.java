...
import org.zeron.sophon.authn.support.basic.BasicEntryPoint;
import org.zeron.sophon.authn.support.httpheader.HttpHeaderEntryPoint;
import org.zeron.sophon.authn.support.kerberos.HttpKerberosEntryPoint;
import org.zeron.sophon.authn.support.kerberos.KerberosService;
...
import org.zeron.sophon.web.interceptor.HistorySingleSignOnInterceptor;
import org.zeron.sophon.web.interceptor.SingleSignOnInterceptor;
...
@EnableWebMvc
@AutoConfiguration
public class SophonMvcConfig implements WebMvcConfigurer {
    private static final  Logger logger = LoggerFactory.getLogger(SophonMvcConfig.class);
   
    @Value("${sophon.login.basic.enable:false}")
    private boolean basicEnable;
    
    @Value("${sophon.login.httpheader.enable:false}")
    private boolean httpHeaderEnable;
    
    @Value("${sophon.login.httpheader.headername:iv-user}")
