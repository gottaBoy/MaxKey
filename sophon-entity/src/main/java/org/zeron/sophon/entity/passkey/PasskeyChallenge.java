...
package org.zeron.sophon.entity.passkey;
...
/**
 * Passkey挑战实体类，用于存储注册和认证过程中的挑战信??
 */
@Entity
@Table(name = "ze_passkey_challenges")
public class PasskeyChallenge extends JpaEntity implements Serializable {
    ...
    private String challengeType; // REGISTRATION ??AUTHENTICATION
    ...
    private Integer status = 0; // 0: 鏈娇鐢? 1: 宸蹭娇鐢? 2: 宸茶繃鏈?
    ...
    public PasskeyChallenge() {
        ...
        this.expiresDate = new Date(now.getTime() + 5 * 60 * 1000); // 5鍒嗛挓杩囨湡
    }
