...
CREATE TABLE `ze_history_system_logs` (
  ...
  `MESSAGE` varchar(200) DEFAULT NULL COMMENT 'MESSAGE',
  `MESSAGETYPE` varchar(45) DEFAULT NULL COMMENT 'OPERATETYPE',
...
CREATE TABLE `ze_institutions` (
  ...
  `captchaType` varchar(45) DEFAULT 'TEXT',
...
--
-- Table structure for table `ze_role_privileges`
--

DROP TABLE IF EXISTS `ze_role_privileges`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_role_privileges` (
  `id` varchar(50) NOT NULL,
  `appid` varchar(50) DEFAULT NULL,
