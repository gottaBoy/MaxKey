...
CREATE TABLE `ze_apps` (
  `ID` varchar(45) NOT NULL COMMENT '涓婚敭',
  `APPNAME` varchar(100) NOT NULL COMMENT '搴旂敤鍚嶇О',
  ...
  `PROTOCOL` varchar(45) DEFAULT NULL COMMENT '鍗曠偣鐧诲綍鍗忚',
  ...
  `INDUCER` varchar(10) DEFAULT 'IDP' COMMENT '寮曞鏂瑰紡',
  `LOGOUTURL` varchar(300) DEFAULT NULL COMMENT '娉ㄩ攢鍦板潃',
  `LOGOUTTYPE` tinyint DEFAULT NULL COMMENT '鍗曠偣娉ㄩ攢鏂瑰紡 0 NONE,1 BACK_CHANNEL,2 FRONT_CHANNEL',
  `INSTID` varchar(45) NOT NULL,
...
CREATE TABLE `ze_history_login` (
  ...
  `INSTID` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `idx_ze_hl_session_id` (`SESSIONID`)
...
-- Dump completed on 2024-11-27 15:24:45
