...
CREATE TABLE `ze_apps` (
  ...
  `CREDENTIAL` varchar(45) DEFAULT '0' COMMENT '鍗曠偣鐧诲綍鍑瘉绫诲瀷',
...
CREATE TABLE `ze_connectors` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='杩炴帴鍣?;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ze_userinfo` (
  ...
  `SORTORDER` tinyint unsigned DEFAULT '1' COMMENT '閮ㄩ棬鍐呮帓搴?,
...
-- Dump completed on 2022-12-26 10:10:09
