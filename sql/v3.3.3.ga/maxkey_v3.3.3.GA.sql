...
CREATE TABLE `ze_accounts` (
  ...
  `RELATEDPASSWORD` varchar(400) DEFAULT NULL COMMENT '瀵嗙爜',
  ...
  `MODIFIEDDATE` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '淇敼鏃堕棿',
  `INSTID` varchar(45) NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNIQUE_USER_ACCOUNT` (`USERNAME`,`APPID`,`RELATEDUSERNAME`,`USERID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='鐢ㄦ埛璐﹀彿琛?;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ze_accounts_strategy`
--

DROP TABLE IF EXISTS `ze_accounts_strategy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_accounts_strategy` (
...
CREATE TABLE `ze_apps` (
  `ID` varchar(45) NOT NULL COMMENT '涓婚敭',
  `NAME` varchar(300) NOT NULL COMMENT '搴旂敤鍚嶇О',
  ...
  `SECRET` varchar(400) DEFAULT NULL COMMENT '搴旂敤瀵嗛挜',
  `PROTOCOL` varchar(300) DEFAULT NULL COMMENT '鍗曠偣鐧诲綍鍗忚',
  `ICON` blob COMMENT '搴旂敤鍥炬爣',
  ...
  `CREDENTIAL` tinyint DEFAULT '0' COMMENT '鍗曠偣鐧诲綍鍑瘉绫诲瀷',
  `SHAREDUSERNAME` varchar(100) DEFAULT NULL COMMENT '鍏变韩鐢ㄦ埛鍚?,
  `SHAREDPASSWORD` varchar(400) DEFAULT NULL COMMENT '鍏变韩瀵嗙爜',
  ...
  `CREDENTIALS` varchar(200) DEFAULT NULL COMMENT '鎺ュ彛API鐢ㄦ埛鍑瘉',
  ...
  `INSTID` varchar(45) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='搴旂敤琛?;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ze_apps_oauth_client_details` (
  ...
  `CLIENT_SECRET` varchar(400) DEFAULT NULL COMMENT 'appsecret',
...
CREATE TABLE `ze_apps_token_based_details` (
  `ID` varchar(45) NOT NULL COMMENT 'ID',
  `ALGORITHMKEY` varchar(400) NOT NULL COMMENT '绉橀挜',
...
--
-- Table structure for table `ze_email_senders`
--

DROP TABLE IF EXISTS `ze_email_senders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_email_senders` (
  `id` varchar(50) NOT NULL,
...
--
-- Table structure for table `ze_group_privileges`
--

DROP TABLE IF EXISTS `ze_group_privileges`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_group_privileges` (
  `ID` varchar(45) NOT NULL COMMENT 'ID',
...
CREATE TABLE `ze_groups` (
  ...
  `DYNAMIC` varchar(2) DEFAULT NULL COMMENT '鍔ㄦ€佺敤鎴风粍锛?鍚?1鏄?,
...
CREATE TABLE `ze_history_login` (
  ...
  `IpRegion` varchar(500) DEFAULT NULL,
  `ipLocation` varchar(500) DEFAULT NULL,
...
--
-- Table structure for table `ze_history_logs`
--

DROP TABLE IF EXISTS `ze_history_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_history_logs` (
  `ID` varchar(45) NOT NULL COMMENT 'ID',
...
CREATE TABLE `ze_institutions` (
  ...
  `captchasupport` varchar(45) DEFAULT 'YES',
  `captcha` varchar(45) DEFAULT 'TEXT',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='institutions鏈烘瀯琛紝瀛樻斁绉熸埛淇℃伅multi-tenancy';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ze_ldap_context`
--

DROP TABLE IF EXISTS `ze_ldap_context`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_ldap_context` (
  `id` varchar(50) NOT NULL,
...
--
-- Table structure for table `ze_notices`
--

DROP TABLE IF EXISTS `ze_notices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_notices` (
  `ID` varchar(50) NOT NULL,
  ...
  `INSTID` varchar(45) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='閫氱煡';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ze_organizations_cast` (
  ...
  `INSTID` varchar(45) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='鏈烘瀯鏄犲皠琛?;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ze_password_policy`
--

DROP TABLE IF EXISTS `ze_password_policy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_password_policy` (
  `ID` varchar(45) NOT NULL,
...
--
-- Table structure for table `ze_role_permissions`
--

DROP TABLE IF EXISTS `ze_role_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_role_permissions` (
  `id` varchar(50) NOT NULL,
  `appid` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `ze_sms_provider`
--

DROP TABLE IF EXISTS `ze_sms_provider`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_sms_provider` (
  `id` varchar(50) NOT NULL,
...
CREATE TABLE `ze_synchronizers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='鍚屾鍣?;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ze_userinfo` (
  ...
  `PASSWORD` varchar(200) NOT NULL COMMENT '瀵嗙爜',
  `DECIPHERABLE` varchar(400) NOT NULL COMMENT 'DE瀵嗙爜',
  ...
  `ONLINE` tinyint unsigned DEFAULT NULL COMMENT '鍦ㄧ嚎鐘舵€?,
  `STATUS` tinyint unsigned DEFAULT NULL COMMENT '鐢ㄦ埛鐘舵€?,
  `ISLOCKED` tinyint unsigned DEFAULT NULL COMMENT '閿佸畾鐘舵€?,
  `UNLOCKTIME` datetime DEFAULT '2020-01-01 01:01:01' COMMENT '瑙ｉ攣鏃堕棿',
  `LASTLOGINIP` varchar(45) DEFAULT NULL COMMENT '鏈€杩戠櫥褰旾P鍦板潃',
  ...
  `SORTORDER` tinyint unsigned DEFAULT '0' COMMENT '閮ㄩ棬鍐呮帓搴?,
...
--
-- Table structure for table `ze_userinfo_adjunct`
--

DROP TABLE IF EXISTS `ze_userinfo_adjunct`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ze_userinfo_adjunct` (
  `ID` varchar(45) NOT NULL COMMENT '缂栧彿',
  `USERID` varchar(45) NOT NULL COMMENT '鐢ㄦ埛缂栧彿',
  `ORGANIZATION` varchar(45) DEFAULT NULL COMMENT '鏈烘瀯',
  `DEPARTMENTID` varchar(45) DEFAULT NULL COMMENT '閮ㄩ棬缂栧彿',
  `DEPARTMENT` varchar(45) DEFAULT NULL COMMENT '閮ㄩ棬',
  `JOBTITLE` varchar(45) DEFAULT NULL COMMENT '鑱屽姟',
  ...
  `WORKEMAIL` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-閭欢',
  `WORKPHONENUMBER` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-鐢佃瘽',
  `WORKCOUNTRY` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-鍥藉',
  `WORKREGION` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-鐪?甯?,
  `WORKLOCALITY` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-鍩庡競',
  `WORKSTREETADDRESS` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-琛楅亾',
  `WORKADDRESSFORMATTED` varchar(45) DEFAULT NULL COMMENT '宸ヤ綔-鍦板潃鍏ㄧО',
