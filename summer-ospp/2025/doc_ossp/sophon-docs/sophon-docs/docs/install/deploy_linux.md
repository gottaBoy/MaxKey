...
https://gitee.com/dromara/Sophon/tree/main/sql
...
-- 浣跨敤source鍛戒护锛屽悗闈㈠弬鏁颁负鑴氭湰鏂囦欢(濡傝繖閲岀敤鍒扮殑.sql),鍏朵腑v4.0.5.ga鏄搴旂殑鐗堟湰鍙?

source your sql path/Sophon.sql;

source your sql path/Sophon_data.sql
