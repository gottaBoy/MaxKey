...
package org.apache.shenyu.plugin.Sophon.handle;
...
class SophonPluginDataHandlerTest {

    private SophonPluginDataHandler SophonPluginDataHandlerTest;

    @BeforeEach
    public void setup() {
        SophonPluginDataHandlerTest = new SophonPluginDataHandler();
    }
    ...
    public void testPluginNamed() {
        final String result = SophonPluginDataHandlerTest.pluginNamed();
        assertEquals(PluginEnum.Sophon.getName(), result);
    }
}
