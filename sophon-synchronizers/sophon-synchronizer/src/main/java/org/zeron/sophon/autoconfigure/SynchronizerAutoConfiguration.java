...
import org.zeron.sophon.synchronizer.SynchronizerJob;
...
public class SynchronizerAutoConfiguration   implements InitializingBean {
    ...
    public static final String SYNCHRONIZERS_SELECT_STATEMENT = "select * from ze_synchronizers where status ='1'";

    @Bean(name = "schedulerSynchronizerJobs")
    String schedulerSynchronizerJobs(
                JdbcTemplate  jdbcTemplate,
                SchedulerFactoryBean schedulerFactoryBean,
                @Value("${sophon.job.cron.enable}") boolean jobCronEnable
